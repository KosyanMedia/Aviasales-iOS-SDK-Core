...
/**
 *  The method is called if a search error has occurred.
 *
 *  @param airportsSearchPerformer The search performer itself
 *  @param error               The error
 */
- (void)airportsSearchPerformer:(AviasalesAirportsSearchPerformer *)airportsSearchPerformer didFailSearchingWithError:(NSError *)error;
